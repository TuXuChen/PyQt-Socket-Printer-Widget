...
class ToolBar(QWidget):
    ...
    def __initWidget(self):
        ...
        self.themeButton.setToolTip(self.tr('切换 主题'))
        self.helpButton.setToolTip(self.tr('文档 说明'))

        self.themeButton.clicked.connect(self.toggleTheme)
        self.helpButton.clicked.connect(lambda: signalBus.switchToSampleCard.emit("helpInterface", 3))
